...
<template>
  <div class="home-container">
    <article class="card shadow">
      ...
      <img src="../assets/img/rocket-grunt.webp" class="grunt-img" alt="Rocket grunt" />
    </article>
    <!-- MAIN WINDOW -->
    <article class="card shadow">
      <div class="card-body">
        ...
        <section class="container">
          ...
          <div class="row">
            ...
            <span>${{ money }} <button class="btn btn-dark-cyan text-white" @click="trashForDollars()">Exchange Trash
                for
                $1</button></span>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-4">
              <button class="btn btn-vue w-100 mdi mdi-store" @click="toggleStore()">
                Store
              </button>
            </div>
            <div class="col-4">
